...
#define __PYX_HAVE__qutip__cy__math
#define __PYX_HAVE_API__qutip__cy__math
/* Early includes */
#include <math.h>
#include <complex>
#ifdef _OPENMP
...
/* Module declarations from 'qutip.cy.math' */
#define __Pyx_MODULE_NAME "qutip.cy.math"
extern int __pyx_module_is_main_qutip__cy__math;
int __pyx_module_is_main_qutip__cy__math = 0;

/* Implementation of 'qutip.cy.math' */
...
static double __pyx_f_5qutip_2cy_4math_erf(double __pyx_v_x) {
  double __pyx_v_c;
  double __pyx_v_a[5];
  double __pyx_v_b[3];
  double __pyx_v_p[8];
 ...
 */
  __pyx_t_7 = ((__pyx_v_ax <= 0.5) != 0);
  if (__pyx_t_7) {

    /* "qutip/cy/math.pyx":78
 * 
 *     if ax <= 0.5:
 *         t = x*x             # <<<<<<<<<<<<<<
 *         top = ((((a[0]*t+a[1])*t+a[2])*t+a[3])*t+a[4]) + 1.0
 ...
 */
  __pyx_t_7 = ((__pyx_v_ax <= 4.0) != 0);
  if (__pyx_t_7) {

    /* "qutip/cy/math.pyx":84
 *         return erf
 *     elif ax <= 4.0:
 *         x2 = x*x             # <<<<<<<<<<<<<<
 *         top = ((((((p[0]*ax+p[1])*ax+p[2])*ax+p[3])*ax+p[4])*ax+p[5])*ax+p[6])*ax + p[7]
 ...
 *         t = 1.0/x2
 */
  __pyx_t_7 = ((__pyx_v_ax < 5.8) != 0);
  if (__pyx_t_7) {

    /* "qutip/cy/math.pyx":92
 *         return erf
 *     elif ax < 5.8:
 *         x2 = x*x             # <<<<<<<<<<<<<<
 *         t = 1.0/x2
...
static __pyx_t_double_complex __pyx_f_5qutip_2cy_4math_zerf(__pyx_t_double_complex __pyx_v_Z) {
  double __pyx_v_EPS;
  double __pyx_v_X;
  double __pyx_v_Y;
  double __pyx_v_X2;
  ...
  int __pyx_t_1;
  size_t __pyx_t_2;
  __Pyx_RefNannySetupContext("zerf", 0);

  /* "qutip/cy/math.pyx":131
 *     """
 * 
 ...
 *         R = 1.0
 */
  __pyx_t_1 = ((__pyx_v_X < 3.5) != 0);
  if (__pyx_t_1) {

    /* "qutip/cy/math.pyx":141
 * 
 *     if X < 3.5:
 *         ER = 1.0             # <<<<<<<<<<<<<<
 *         R = 1.0
 ...
 *             W = ER
 */
      __pyx_t_1 = ((fabs((__pyx_v_ER - __pyx_v_W)) < (__pyx_v_EPS * fabs(__pyx_v_ER))) != 0);
      if (__pyx_t_1) {

        /* "qutip/cy/math.pyx":148
 *             ER = ER+R
 *             if (fabs(ER-W) < EPS*fabs(ER)):
 *                 break             # <<<<<<<<<<<<<<
 *             W = ER
 ...
 *             W1 = ER2
 */
      __pyx_t_1 = ((fabs(((__pyx_v_ER2 - __pyx_v_W1) / __pyx_v_ER2)) < __pyx_v_EPS) != 0);
      if (__pyx_t_1) {

        /* "qutip/cy/math.pyx":175
 *             ER2 = ER2+exp(-.25*N*N)/(N*N+4.0*X2)*(2.0*X-2.0*X*cosh(N*Y)*CS+N*sinh(N*Y)*SS)
 *             if (fabs((ER2-W1)/ER2) < EPS):
 *                 break             # <<<<<<<<<<<<<<
 *             W1 = ER2
 ...
 *             W2 = EI2
 */
      __pyx_t_1 = ((fabs(((__pyx_v_EI2 - __pyx_v_W2) / __pyx_v_EI2)) < __pyx_v_EPS) != 0);
      if (__pyx_t_1) {

        /* "qutip/cy/math.pyx":186
 *             EI2 = EI2+exp(-.25*N*N)/(N*N+4.0*X2)*(2.0*X*cosh(N*Y)*SS+N*sinh(N*Y)*CS)
 *             if (fabs((EI2-W2)/EI2) < EPS):
 *                 break             # <<<<<<<<<<<<<<
 *             W2 = EI2
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("erf", (void (*)(void))__pyx_f_5qutip_2cy_4math_erf, "double (double)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("zerf", (void (*)(void))__pyx_f_5qutip_2cy_4math_zerf, "__pyx_t_double_complex (__pyx_t_double_complex)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_qutip__cy__math) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "qutip.cy.math")) {
      if (unlikely(PyDict_SetItemString(modules, "qutip.cy.math", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init qutip.cy.math", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init qutip.cy.math");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
