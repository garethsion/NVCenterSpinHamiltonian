...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "language": "c++",
        "name": "qutip.cy.interpolate",
        "sources": [
            "qutip/cy/interpolate.pyx",
            "qutip/cy/src/zspmv.cpp"
        ]
    },
    "module_name": "qutip.cy.interpolate"
}
END: Cython Metadata */
...
#define __PYX_HAVE__qutip__cy__interpolate
#define __PYX_HAVE_API__qutip__cy__interpolate
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'qutip.cy.interpolate' */
...
static double __pyx_f_5qutip_2cy_11interpolate_interp(double, double, double, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static __pyx_t_double_complex __pyx_f_5qutip_2cy_11interpolate_zinterp(double, double, double, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static CYTHON_INLINE double __pyx_f_5qutip_2cy_11interpolate_phi(double); /*proto*/
...
#define __Pyx_MODULE_NAME "qutip.cy.interpolate"
extern int __pyx_module_is_main_qutip__cy__interpolate;
int __pyx_module_is_main_qutip__cy__interpolate = 0;

/* Implementation of 'qutip.cy.interpolate' */
...
static const char __pyx_k_arr_interp[] = "arr_interp";
static const char __pyx_k_pyx_result[] = "__pyx_result";
static const char __pyx_k_pyx_vtable[] = "__pyx_vtable__";
static const char __pyx_k_ImportError[] = "ImportError";
static const char __pyx_k_MemoryError[] = "MemoryError";
static const char __pyx_k_PickleError[] = "PickleError";
static const char __pyx_k_arr_zinterp[] = "arr_zinterp";
...
static const char __pyx_k_qutip_cy_interpolate[] = "qutip.cy.interpolate";
...
static const char __pyx_k_qutip_cy_interpolate_pyx[] = "qutip/cy/interpolate.pyx";
...
static PyObject *__pyx_n_s_arr_interp;
static PyObject *__pyx_n_s_arr_zinterp;
...
static PyObject *__pyx_n_s_qutip_cy_interpolate;
static PyObject *__pyx_kp_s_qutip_cy_interpolate_pyx;
...
static PyObject *__pyx_pf_5qutip_2cy_11interpolate_interp(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_x, double __pyx_v_a, double __pyx_v_b, __Pyx_memviewslice __pyx_v_c); /* proto */
static PyObject *__pyx_pf_5qutip_2cy_11interpolate_2zinterp(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_x, double __pyx_v_a, double __pyx_v_b, __Pyx_memviewslice __pyx_v_c); /* proto */
static PyObject *__pyx_pf_5qutip_2cy_11interpolate_4arr_interp(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, double __pyx_v_a, double __pyx_v_b, __Pyx_memviewslice __pyx_v_c); /* proto */
static PyObject *__pyx_pf_5qutip_2cy_11interpolate_6arr_zinterp(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, double __pyx_v_a, double __pyx_v_b, __Pyx_memviewslice __pyx_v_c); /* proto */
...
static CYTHON_INLINE double __pyx_f_5qutip_2cy_11interpolate_phi(double __pyx_v_t) {
  double __pyx_v_abs_t;
  double __pyx_r;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  __Pyx_RefNannySetupContext("phi", 0);

  /* "qutip/cy/interpolate.pyx":44
 * cdef inline double phi(double t):
 * 
 *     cdef double abs_t = fabs(t)             # <<<<<<<<<<<<<<
 *     if abs_t <= 1:
 ...
 */
  __pyx_v_abs_t = fabs(__pyx_v_t);

  /* "qutip/cy/interpolate.pyx":45
 * 
 *     cdef double abs_t = fabs(t)
 *     if abs_t <= 1:             # <<<<<<<<<<<<<<
 *         return 4 - 6 * abs_t**2 + 3 * abs_t**3
 *     elif abs_t <= 2:
 */
  __pyx_t_1 = ((__pyx_v_abs_t <= 1.0) != 0);
  if (__pyx_t_1) {

    /* "qutip/cy/interpolate.pyx":46
 *     cdef double abs_t = fabs(t)
 *     if abs_t <= 1:
 *         return 4 - 6 * abs_t**2 + 3 * abs_t**3             # <<<<<<<<<<<<<<
 *     elif abs_t <= 2:
 *         return (2-abs_t)**3
 */
    __pyx_r = ((4.0 - (6.0 * pow(__pyx_v_abs_t, 2.0))) + (3.0 * pow(__pyx_v_abs_t, 3.0)));
    goto __pyx_L0;
 ...
 *     else:
 */
  __pyx_t_1 = ((__pyx_v_abs_t <= 2.0) != 0);
  if (__pyx_t_1) {

    /* "qutip/cy/interpolate.pyx":48
 *         return 4 - 6 * abs_t**2 + 3 * abs_t**3
 *     elif abs_t <= 2:
 *         return (2-abs_t)**3             # <<<<<<<<<<<<<<
 *     else:
 *         return 0
 */
    __pyx_r = pow((2.0 - __pyx_v_abs_t), 3.0);
    goto __pyx_L0;
...
static PyObject *__pyx_pw_5qutip_2cy_11interpolate_1interp(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static double __pyx_f_5qutip_2cy_11interpolate_interp(double __pyx_v_x, double __pyx_v_a, double __pyx_v_b, __Pyx_memviewslice __pyx_v_c, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_n;
  double __pyx_v_h;
  int __pyx_v_l;
  int __pyx_v_m;
 ...
 */
  __pyx_v_n = ((__pyx_v_c.shape[0]) - 3);

  /* "qutip/cy/interpolate.pyx":58
 * cpdef double interp(double x, double a, double b, double[::1] c):
 *     cdef int n = c.shape[0] - 3
 *     cdef double h = (b-a) / n             # <<<<<<<<<<<<<<
 *     cdef int l = <int>((x-a)/h) + 1
 ...
 *     cdef size_t ii
 */
  __pyx_v_l = (((int)((__pyx_v_x - __pyx_v_a) / __pyx_v_h)) + 1);

  /* "qutip/cy/interpolate.pyx":60
 *     cdef double h = (b-a) / n
 *     cdef int l = <int>((x-a)/h) + 1
 *     cdef int m = <int>(fmin(l+3, n+3))             # <<<<<<<<<<<<<<
 *     cdef size_t ii
 ...
 */
  __pyx_v_pos = (((__pyx_v_x - __pyx_v_a) / __pyx_v_h) + 2.0);

  /* "qutip/cy/interpolate.pyx":65
 *     cdef double pos = (x-a)/h + 2
 * 
 *     for ii in range(l, m+1):             # <<<<<<<<<<<<<<
 *         _tmp = phi(pos - ii)
 ...
 *             s += c[ii-1] * _tmp
 */
    __pyx_v__tmp = __pyx_f_5qutip_2cy_11interpolate_phi((__pyx_v_pos - __pyx_v_ii));

    /* "qutip/cy/interpolate.pyx":67
 *     for ii in range(l, m+1):
 *         _tmp = phi(pos - ii)
 *         if _tmp:             # <<<<<<<<<<<<<<
 *             s += c[ii-1] * _tmp
 *     return s
 */
    __pyx_t_4 = (__pyx_v__tmp != 0);
    if (__pyx_t_4) {

      /* "qutip/cy/interpolate.pyx":68
 *         _tmp = phi(pos - ii)
 *         if _tmp:
 *             s += c[ii-1] * _tmp             # <<<<<<<<<<<<<<
 *     return s
 ...
 */
      ...
      __pyx_v_s = (__pyx_v_s + ((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_c.data) + __pyx_t_5)) ))) * __pyx_v__tmp));
...
/* Python wrapper */
static PyObject *__pyx_pw_5qutip_2cy_11interpolate_1interp(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_5qutip_2cy_11interpolate_1interp(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  double __pyx_v_x;
  double __pyx_v_a;
  double __pyx_v_b;
  ...
  __Pyx_RefNannySetupContext("interp (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_a)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("interp", 1, 4, 4, 1); __PYX_ERR(0, 56, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_b)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("interp", 1, 4, 4, 2); __PYX_ERR(0, 56, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_c)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("interp", 1, 4, 4, 3); __PYX_ERR(0, 56, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "interp") < 0)) __PYX_ERR(0, 56, __pyx_L3_error)
      }
    ...
    __pyx_v_x = __pyx_PyFloat_AsDouble(values[0]); if (unlikely((__pyx_v_x == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 56, __pyx_L3_error)
    __pyx_v_a = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_a == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 56, __pyx_L3_error)
    __pyx_v_b = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_b == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 56, __pyx_L3_error)
    __pyx_v_c = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_c.memview)) __PYX_ERR(0, 56, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("interp", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 56, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("qutip.cy.interpolate.interp", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5qutip_2cy_11interpolate_interp(__pyx_self, __pyx_v_x, __pyx_v_a, __pyx_v_b, __pyx_v_c);
...
static PyObject *__pyx_pf_5qutip_2cy_11interpolate_interp(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_x, double __pyx_v_a, double __pyx_v_b, __Pyx_memviewslice __pyx_v_c) {
  ...
  if (unlikely(!__pyx_v_c.memview)) { __Pyx_RaiseUnboundLocalError("c"); __PYX_ERR(0, 56, __pyx_L1_error) }
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_5qutip_2cy_11interpolate_interp(__pyx_v_x, __pyx_v_a, __pyx_v_b, __pyx_v_c, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 56, __pyx_L1_error)
...
static PyObject *__pyx_pw_5qutip_2cy_11interpolate_3zinterp(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __pyx_t_double_complex __pyx_f_5qutip_2cy_11interpolate_zinterp(double __pyx_v_x, double __pyx_v_a, double __pyx_v_b, __Pyx_memviewslice __pyx_v_c, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_n;
  double __pyx_v_h;
  int __pyx_v_l;
  int __pyx_v_m;
  ...
  int __pyx_t_4;
  size_t __pyx_t_5;
  __Pyx_RefNannySetupContext("zinterp", 0);

  /* "qutip/cy/interpolate.pyx":76
 * @cython.cdivision(True)
 * cpdef complex zinterp(double x, double a, double b, complex[::1] c):
 *     cdef int n = c.shape[0] - 3             # <<<<<<<<<<<<<<
 *     cdef double h = (b-a) / n
 ...
 */
      __pyx_t_5 = (__pyx_v_ii - 1);
      __pyx_v_s = __Pyx_c_sum_double(__pyx_v_s, __Pyx_c_prod_double((*((__pyx_t_double_complex *) ( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_c.data) + __pyx_t_5)) ))), __pyx_t_double_complex_from_parts(__pyx_v__tmp, 0)));
...
/* Python wrapper */
static PyObject *__pyx_pw_5qutip_2cy_11interpolate_3zinterp(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_5qutip_2cy_11interpolate_3zinterp(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  double __pyx_v_x;
  double __pyx_v_a;
  double __pyx_v_b;
  __Pyx_memviewslice __pyx_v_c = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("zinterp (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_x,&__pyx_n_s_a,&__pyx_n_s_b,&__pyx_n_s_c,0};
    PyObject* values[4] = {0,0,0,0};
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_a)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("zinterp", 1, 4, 4, 1); __PYX_ERR(0, 75, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_b)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("zinterp", 1, 4, 4, 2); __PYX_ERR(0, 75, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_c)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("zinterp", 1, 4, 4, 3); __PYX_ERR(0, 75, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "zinterp") < 0)) __PYX_ERR(0, 75, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 4) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_c = __Pyx_PyObject_to_MemoryviewSlice_dc___pyx_t_double_complex(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_c.memview)) __PYX_ERR(0, 75, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("zinterp", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 75, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("qutip.cy.interpolate.zinterp", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5qutip_2cy_11interpolate_2zinterp(__pyx_self, __pyx_v_x, __pyx_v_a, __pyx_v_b, __pyx_v_c);
...
static PyObject *__pyx_pf_5qutip_2cy_11interpolate_2zinterp(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_x, double __pyx_v_a, double __pyx_v_b, __Pyx_memviewslice __pyx_v_c) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  __Pyx_RefNannySetupContext("zinterp", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_c.memview)) { __Pyx_RaiseUnboundLocalError("c"); __PYX_ERR(0, 75, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_5qutip_2cy_11interpolate_zinterp(__pyx_v_x, __pyx_v_a, __pyx_v_b, __pyx_v_c, 0);
  __pyx_t_2 = __pyx_PyComplex_FromComplex(__pyx_t_1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 75, __pyx_L1_error)
...
/* Python wrapper */
static PyObject *__pyx_pw_5qutip_2cy_11interpolate_5arr_interp(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_5qutip_2cy_11interpolate_5arr_interp = {"arr_interp", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_5qutip_2cy_11interpolate_5arr_interp, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_5qutip_2cy_11interpolate_5arr_interp(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("arr_interp (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_x,&__pyx_n_s_a,&__pyx_n_s_b,&__pyx_n_s_c,0};
    PyObject* values[4] = {0,0,0,0};
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_a)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("arr_interp", 1, 4, 4, 1); __PYX_ERR(0, 94, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_b)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("arr_interp", 1, 4, 4, 2); __PYX_ERR(0, 94, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_c)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("arr_interp", 1, 4, 4, 3); __PYX_ERR(0, 94, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "arr_interp") < 0)) __PYX_ERR(0, 94, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 4) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_x = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_x.memview)) __PYX_ERR(0, 94, __pyx_L3_error)
    __pyx_v_a = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_a == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 94, __pyx_L3_error)
    __pyx_v_b = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_b == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 94, __pyx_L3_error)
    __pyx_v_c = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_c.memview)) __PYX_ERR(0, 94, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("arr_interp", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 94, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("qutip.cy.interpolate.arr_interp", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5qutip_2cy_11interpolate_4arr_interp(__pyx_self, __pyx_v_x, __pyx_v_a, __pyx_v_b, __pyx_v_c);
...
static PyObject *__pyx_pf_5qutip_2cy_11interpolate_4arr_interp(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, double __pyx_v_a, double __pyx_v_b, __Pyx_memviewslice __pyx_v_c) {
  int __pyx_v_lenx;
  int __pyx_v_lenc;
  int __pyx_v_n;
  double __pyx_v_h;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("arr_interp", 0);
 ...
 *     cdef int n = lenc - 3
 */
  __pyx_v_lenx = (__pyx_v_x.shape[0]);

  /* "qutip/cy/interpolate.pyx":96
 * def arr_interp(double[::1] x, double a, double b, double[::1] c):
 *     cdef int lenx = x.shape[0]
 *     cdef int lenc = c.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int n = lenc - 3
 *     cdef double h = (b-a) / n
 */
  __pyx_v_lenc = (__pyx_v_c.shape[0]);

  /* "qutip/cy/interpolate.pyx":97
 *     cdef int lenx = x.shape[0]
 *     cdef int lenc = c.shape[0]
 *     cdef int n = lenc - 3             # <<<<<<<<<<<<<<
 *     cdef double h = (b-a) / n
 *     cdef size_t ii, jj
 */
  __pyx_v_n = (__pyx_v_lenc - 3);

  /* "qutip/cy/interpolate.pyx":98
 *     cdef int lenc = c.shape[0]
 *     cdef int n = lenc - 3
 *     cdef double h = (b-a) / n             # <<<<<<<<<<<<<<
 *     cdef size_t ii, jj
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_lenx); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 102, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_dtype, ((PyObject *)(&PyFloat_Type))) < 0) __PYX_ERR(0, 102, __pyx_L1_error)
  __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_3, __pyx_t_1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 102, __pyx_L1_error)
 ...
 *         m = <int>(fmin(l+3, n+3))
 */
  __pyx_t_6 = __pyx_v_lenx;
  __pyx_t_7 = __pyx_t_6;
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
    __pyx_v_jj = __pyx_t_8;

    /* "qutip/cy/interpolate.pyx":105
 * 
 *     for jj in range(lenx):
 *         l = <int>((x[jj]-a)/h) + 1             # <<<<<<<<<<<<<<
 *         m = <int>(fmin(l+3, n+3))
 ...
 */
    ...
    __pyx_v_l = (((int)(((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_x.data) + __pyx_t_9)) ))) - __pyx_v_a) / __pyx_v_h)) + 1);

    /* "qutip/cy/interpolate.pyx":106
 *     for jj in range(lenx):
 *         l = <int>((x[jj]-a)/h) + 1
 *         m = <int>(fmin(l+3, n+3))             # <<<<<<<<<<<<<<
 *         pos = (x[jj]-a)/h + 2
 ...
 */
    __pyx_t_9 = __pyx_v_jj;
    __pyx_v_pos = ((((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_x.data) + __pyx_t_9)) ))) - __pyx_v_a) / __pyx_v_h) + 2.0);

    /* "qutip/cy/interpolate.pyx":109
 *         pos = (x[jj]-a)/h + 2
 * 
 *         for ii in range(l, m+1):             # <<<<<<<<<<<<<<
 *             _tmp = phi(pos - ii)
 ...
 */
    ...
    for (__pyx_t_9 = __pyx_v_l; __pyx_t_9 < __pyx_t_11; __pyx_t_9+=1) {
      __pyx_v_ii = __pyx_t_9;

      /* "qutip/cy/interpolate.pyx":110
 * 
 *         for ii in range(l, m+1):
 *             _tmp = phi(pos - ii)             # <<<<<<<<<<<<<<
 *             if _tmp:
 ...
 * 
 */
      __pyx_t_12 = (__pyx_v__tmp != 0);
      if (__pyx_t_12) {

        /* "qutip/cy/interpolate.pyx":112
 *             _tmp = phi(pos - ii)
 *             if _tmp:
 *                 out[jj] += c[ii-1] * _tmp             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        *__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_out.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_out.diminfo[0].strides) += ((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_c.data) + __pyx_t_13)) ))) * __pyx_v__tmp);
...
/* Python wrapper */
static PyObject *__pyx_pw_5qutip_2cy_11interpolate_7arr_zinterp(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_5qutip_2cy_11interpolate_7arr_zinterp = {"arr_zinterp", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_5qutip_2cy_11interpolate_7arr_zinterp, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_5qutip_2cy_11interpolate_7arr_zinterp(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_x = { 0, 0, { 0 }, { 0 }, { 0 } };
  double __pyx_v_a;
  double __pyx_v_b;
  __Pyx_memviewslice __pyx_v_c = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("arr_zinterp (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_x,&__pyx_n_s_a,&__pyx_n_s_b,&__pyx_n_s_c,0};
    PyObject* values[4] = {0,0,0,0};
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_a)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("arr_zinterp", 1, 4, 4, 1); __PYX_ERR(0, 120, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_b)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("arr_zinterp", 1, 4, 4, 2); __PYX_ERR(0, 120, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_c)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("arr_zinterp", 1, 4, 4, 3); __PYX_ERR(0, 120, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "arr_zinterp") < 0)) __PYX_ERR(0, 120, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 4) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_x = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_x.memview)) __PYX_ERR(0, 120, __pyx_L3_error)
    __pyx_v_a = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_a == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 120, __pyx_L3_error)
    __pyx_v_b = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_b == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 120, __pyx_L3_error)
    __pyx_v_c = __Pyx_PyObject_to_MemoryviewSlice_dc___pyx_t_double_complex(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_c.memview)) __PYX_ERR(0, 120, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("arr_zinterp", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 120, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("qutip.cy.interpolate.arr_zinterp", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5qutip_2cy_11interpolate_6arr_zinterp(__pyx_self, __pyx_v_x, __pyx_v_a, __pyx_v_b, __pyx_v_c);
...
static PyObject *__pyx_pf_5qutip_2cy_11interpolate_6arr_zinterp(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, double __pyx_v_a, double __pyx_v_b, __Pyx_memviewslice __pyx_v_c) {
  int __pyx_v_lenx;
  int __pyx_v_lenc;
  int __pyx_v_n;
  double __pyx_v_h;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("arr_zinterp", 0);
  __pyx_pybuffer_out.pybuffer.buf = NULL;
  __pyx_pybuffer_out.refcount = 0;
  __pyx_pybuffernd_out.data = NULL;
  __pyx_pybuffernd_out.rcbuffer = &__pyx_pybuffer_out;

  /* "qutip/cy/interpolate.pyx":121
 * @cython.cdivision(True)
 * def arr_zinterp(double[::1] x, double a, double b, complex[::1] c):
 *     cdef int lenx = x.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int lenc = c.shape[0]
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_lenx); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 128, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_dtype, ((PyObject *)(&PyComplex_Type))) < 0) __PYX_ERR(0, 128, __pyx_L1_error)
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_out.rcbuffer->pybuffer, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo___pyx_t_double_complex, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
      __pyx_v_out = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_pybuffernd_out.rcbuffer->pybuffer.buf = NULL;
 ...
 */
        ...
        *__Pyx_BufPtrCContig1d(__pyx_t_double_complex *, __pyx_pybuffernd_out.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_out.diminfo[0].strides) = __Pyx_c_sum_double((*__Pyx_BufPtrCContig1d(__pyx_t_double_complex *, __pyx_pybuffernd_out.rcbuffer->pybuffer.buf, __pyx_t_13, __pyx_pybuffernd_out.diminfo[0].strides)), __Pyx_c_prod_double((*((__pyx_t_double_complex *) ( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_c.data) + __pyx_t_14)) ))), __pyx_t_double_complex_from_parts(__pyx_v__tmp, 0)));
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "qutip.cy.interpolate.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "qutip.cy.interpolate.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "qutip.cy.interpolate.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "qutip.cy.interpolate._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"interp", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_5qutip_2cy_11interpolate_1interp, METH_VARARGS|METH_KEYWORDS, 0},
  {"zinterp", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_5qutip_2cy_11interpolate_3zinterp, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_interpolate(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_interpolate},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_arr_interp, __pyx_k_arr_interp, sizeof(__pyx_k_arr_interp), 0, 0, 1, 1},
  {&__pyx_n_s_arr_zinterp, __pyx_k_arr_zinterp, sizeof(__pyx_k_arr_zinterp), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_qutip_cy_interpolate, __pyx_k_qutip_cy_interpolate, sizeof(__pyx_k_qutip_cy_interpolate), 0, 0, 1, 1},
  {&__pyx_kp_s_qutip_cy_interpolate_pyx, __pyx_k_qutip_cy_interpolate_pyx, sizeof(__pyx_k_qutip_cy_interpolate_pyx), 0, 0, 1, 0},
 ...
 *     cdef int lenc = c.shape[0]
 */
  __pyx_tuple__26 = PyTuple_Pack(15, __pyx_n_s_x, __pyx_n_s_a, __pyx_n_s_b, __pyx_n_s_c, __pyx_n_s_lenx, __pyx_n_s_lenc, __pyx_n_s_n, __pyx_n_s_h, __pyx_n_s_ii, __pyx_n_s_jj, __pyx_n_s_l, __pyx_n_s_m, __pyx_n_s_pos, __pyx_n_s_tmp, __pyx_n_s_out); if (unlikely(!__pyx_tuple__26)) __PYX_ERR(0, 94, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__26);
  __Pyx_GIVEREF(__pyx_tuple__26);
  __pyx_codeobj__27 = (PyObject*)__Pyx_PyCode_New(4, 0, 15, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__26, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_qutip_cy_interpolate_pyx, __pyx_n_s_arr_interp, 94, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__27)) __PYX_ERR(0, 94, __pyx_L1_error)
 ...
 *     cdef int lenc = c.shape[0]
 */
  __pyx_tuple__28 = PyTuple_Pack(15, __pyx_n_s_x, __pyx_n_s_a, __pyx_n_s_b, __pyx_n_s_c, __pyx_n_s_lenx, __pyx_n_s_lenc, __pyx_n_s_n, __pyx_n_s_h, __pyx_n_s_ii, __pyx_n_s_jj, __pyx_n_s_l, __pyx_n_s_m, __pyx_n_s_pos, __pyx_n_s_tmp, __pyx_n_s_out); if (unlikely(!__pyx_tuple__28)) __PYX_ERR(0, 120, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__28);
  __Pyx_GIVEREF(__pyx_tuple__28);
  __pyx_codeobj__29 = (PyObject*)__Pyx_PyCode_New(4, 0, 15, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__28, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_qutip_cy_interpolate_pyx, __pyx_n_s_arr_zinterp, 120, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__29)) __PYX_ERR(0, 120, __pyx_L1_error)
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("interp", (void (*)(void))__pyx_f_5qutip_2cy_11interpolate_interp, "double (double, double, double, __Pyx_memviewslice, int __pyx_skip_dispatch)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("zinterp", (void (*)(void))__pyx_f_5qutip_2cy_11interpolate_zinterp, "__pyx_t_double_complex (double, double, double, __Pyx_memviewslice, int __pyx_skip_dispatch)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initinterpolate(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initinterpolate(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_interpolate(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_interpolate(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_interpolate(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'interpolate' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_interpolate(void)", 0);
  ...
  #endif
  if (__pyx_module_is_main_qutip__cy__interpolate) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "qutip.cy.interpolate")) {
      if (unlikely(PyDict_SetItemString(modules, "qutip.cy.interpolate", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     cdef int lenc = c.shape[0]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5qutip_2cy_11interpolate_5arr_interp, NULL, __pyx_n_s_qutip_cy_interpolate); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 94, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_arr_interp, __pyx_t_1) < 0) __PYX_ERR(0, 94, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *     cdef int lenc = c.shape[0]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5qutip_2cy_11interpolate_7arr_zinterp, NULL, __pyx_n_s_qutip_cy_interpolate); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 120, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_arr_zinterp, __pyx_t_1) < 0) __PYX_ERR(0, 120, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "qutip/cy/interpolate.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init qutip.cy.interpolate", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init qutip.cy.interpolate");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
